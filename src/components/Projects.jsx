...
const projects = [
  { title: "Amazon Clone",        description: "A fully responsive UI clone of the Amazon e-commerce website, built to demonstrate layout and styling skills.", tags: ["HTML5","CSS3"],        github: "https://github.com/mayur-tarlekar3/Amezon-clone", live: "https://mayur-tarlekar3.github.io/Amezon-clone/", image: `${import.meta.env.BASE_URL}amazon.png` },
  { title: "Currency Converter",  description: "A real-time currency conversion tool fetching live exchange rates from an API for accurate calculations.",                 tags: ["JavaScript","API","CSS3"],             github: "https://github.com/mayur-tarlekar3/Currency-Converter", live: "https://mayur-tarlekar3.github.io/Currency-Converter/", image: `${import.meta.env.BASE_URL}currency.png` },
  { title: "Rock Paper Scissors", description: "An interactive browser-based Rock Paper Scissors game featuring score tracking and win/loss logic.",                      tags: ["JavaScript","HTML5","CSS3"],                github: "https://github.com/mayur-tarlekar3/Rock-Paper-Scissor-game", live: "https://mayur-tarlekar3.github.io/Rock-Paper-Scissor-game/", image: `${import.meta.env.BASE_URL}rps.png` },
];
